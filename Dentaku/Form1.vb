Public Class Form1
    ...
    Private Sub NumberButtonClick(sender As Object, e As EventArgs) Handles btnx.Click, btn1.Click, btn2.Click, btn3.Click, btn4.Click, btn5.Click, btn6.Click, btn7.Click, btn8.Click, btn9.Click
        ...
        Try
            ...
            'Dim number = NumberAct(numberTemporary, number1, number2, previousButton)
            Dim number = calculatorObject.NumberAct(numberTemporary, previousButton)
    ...
    Private Sub ClearButtonClick(sender As Object, e As EventArgs) Handles btnClear.Click
        ...
        calculatorObject.ClearAct(operatorValue, previousButton)
    ...
    '' 数ボタンが押された時に動作するメソッド
    'Private Function NumberAct(numberTemporary As Integer, ByRef number1 As Integer, ByRef number2 As Integer, ByRef previousButton As OperationType) As Double
    ...
    'Private Sub ClearAct(ByRef number1 As Integer, ByRef number2 As Integer, ByRef operatorValue As OperatorType, ByRef previousButton As OperationType)
    '    number1 = 0
    '    number2 = 0
